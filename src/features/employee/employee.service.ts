...
export class EmployeeService {
    ...
    async findByIdAndSelect(id: Types.ObjectId, selects: Array<keyof EmployeeDocument>) {
        return this.employeeModel.findById(id).select(selects.join(' ')).lean<EmployeeDocument>();
    }
