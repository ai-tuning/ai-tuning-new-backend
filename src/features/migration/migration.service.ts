...
import { collectionsName, MAKE_TYPE_ENUM, RolesEnum, UserStatusEnum } from '../constant';
...
export class MigrationService {
  ...
  constructor(
    ...
    @InjectModel(collectionsName.fileService) private readonly fileServiceModel: Model<FileServiceService>,
