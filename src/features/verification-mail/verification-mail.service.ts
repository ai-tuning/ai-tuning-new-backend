...
export class VerificationMailService {
    constructor(
        @InjectModel(collectionsName.verificationMail)
        private readonly verificationEmailModel: Model<VerificationEmail>,
    ) {}
    ...
    private generateRandomCode(): string {
        ...
        // Pad with leading zeros if the code is less than 6 digits
